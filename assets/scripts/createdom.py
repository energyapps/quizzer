...
for i in range(0, len(data)):
	...
	content2 = '<div data-id="' + str(i) + '" id="question' + str(i) + '" class="question-individual"><div class="question subheadline"><p>' +  \
	str(i + 1) + \
	'. ' + \
	data[i]['question'] + \
...
s1 = '<div id="master_container" class="m_container"><div id="progress-anchor"></div><div class="rowDOE" id="progress"></div><div class="rowDOE" id="header-container">'
##header Added here
...
with open ("assets/scripts/pre.html", "r") as myfile:
    prevbegin=myfile.read().replace('\n', '')

with open ("assets/scripts/post.html", "r") as myfile2:
    prevend=myfile2.read().replace('\n', '')
